...
intro <- tryCatch(
    {
        description <- packageDescription("biocclasses")
...
This is the landing page of the `BiocBook` entitled **The Bioconductor Classes
Handbook**.

This book introduces the reader to common Bioconductor classes and strategies
for using Bioconductor classes for efficent code re-use.

# Docker image {-}

A `Docker` image built from this repository is available here: 

👉 [ghcr.io/Bioconductor/classes.bioconductor.org](https://ghcr.io/Bioconductor/classes.bioconductor.org) 🐳
...
#| eval: false
docker run -it ghcr.io/Bioconductor/classes.bioconductor.org:devel R
```
...
docker run \
    ...
    -e PASSWORD=bioc \
    -p 8787:8787 \
    ghcr.io/Bioconductor/classes.bioconductor.org:devel
```
...
#| eval: false
docker run -it ghcr.io/Bioconductor/classes.bioconductor.org:devel bash
