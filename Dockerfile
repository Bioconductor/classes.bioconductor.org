...
RUN Rscript -e 'remotes::install_local(path = "/opt/pkg/", repos=BiocManager::repositories(), dependencies=TRUE, build_vignettes=FALSE, upgrade=TRUE); sessioninfo::session_info(installed.packages()[,"Package"], include_base = TRUE)'
